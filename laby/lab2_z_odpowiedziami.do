...
//
// * a) ARIMA(2,1,0) ma najniższe AIC. ARIMA(1,1,0) ma najniższe BIC.
// *    BIC faworyzuje prostsze modele.
//
// * b)
// arima gnp96, arima(1,1,0)
// TAK
//
// * c)
// quietly arima gnp96, arima(2,1,2)
// estimates store m_212
// estimates stats m_110 m_111 m_210 m_211 m_011 m_212
//
// *    AIC i BIC się pogarszają.
// *    Wniosek: prosta reguła identyfikacji z ACF/PACF daje punkt
// *    startowy, ale ostateczny wybór opiera się na kryteriach
// *    informacyjnych.
// *	ARIMA(2,1,2) ma aż 5 parametrów, co w praktyce często jest problemem.
...
/*
A
Istotne autokorelacje na pierwszych lagach oznaczają, że model nie wychwytuje 
całej dynamiki krótkookresowej — reszty nie są białym szumem, więc wnioskowanie jest niepoprawne. 

Rozwiązanie: zwiększyć rząd AR lub MA i ponownie sprawdzić korelogram. 

Natomiast pojedynczy istotny lag daleko w ogonie (np. 8 czy 12) to często 
przypadek statystyczny — przy 20 lagach i 5% poziomie istotności spodziewamy 
się około jednego fałszywego odrzucenia.
